        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form id="fileForm" class="form-horizontal" role="form" method="POST" action="{{ route('employee-management.update', ['id' => $employee->id]) }}" enctype="multipart/form-data">
                      ...
                      <div class="form-group{{ $errors->has('PNO') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="PNO" type="text" class="form-control" name="PNO" value="{{ $employee->PNO }}" required>
						...
						<div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="tel" class="form-control" name="phone" value="{{ $employee->phone }}" required>
						...
						<div class="form-group{{ $errors->has('percent') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="percent" type="text" class="form-control" name="percent" value="{{ $employee->percent }}" required>
                       ...
                       <div class="form-group{{ $errors->has('comments') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="comments" rows="5" class="form-control" name="comments" value="{{ $employee->comments }}" required></textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input type="file" id="picture" name="picture" accept="image/jpg,image/png,image/jpeg" />
