                    ...
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('company.update', ['id' => $company->id]) }}">
                        ...
                        <input type="hidden" name="_token" value="{{ csrf_token() }}">
                         <div class="form-group{{ $errors->has('orgno') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="orgno" type="text" class="form-control" name="orgno" value="{{ $company->orgno }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('contact') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="contact" type="text" class="form-control" name="contact" value="{{ $company->contact }}" required autofocus>
						...
						<div class="form-group{{ $errors->has('phone') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="tel" class="form-control" name="phone" value="{{ $company->phone }}" required autofocus>
